...
export function WalletSelector() {
    ...
    const isPortoWallet = connector?.id === "xyz.ithaca.porto";
    const walletType = isEmbeddedWallet
        ? "embedded"
        : isPortoWallet
        ? "porto"
        : connector?.name || "external";
    const isWrongNetwork =
        chainId !== RISE_CHAIN_ID && !isEmbeddedWallet && !isPortoWallet;
                    ...
                    <DialogContent>
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                ...
                                {balance && (
                                    <>
                                        <p className="text-sm font-medium mt-3 mb-1 text-gray-700 dark:text-gray-300">
                                            Balance
                                        </p>
            ...
            <DialogContent>
                ...
                <div className="space-y-4">
                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                        try {
                                            ...
                                            setShowWalletOptions(false);
                                            toast.success(
                                                "Porto wallet connected!"
                                            );
                                        } catch (error) {
                                            console.error(
                                                "Porto connection error:",
                                                error
                                            );
                                            toast.error(
                                                "Failed to connect Porto wallet"
                                            );
                                        }
                                    }}
                    ...
                    <div className="space-y-2">
                        ...
                        <button
                            onClick={() =>
                                setShowEmbeddedOptions(!showEmbeddedOptions)
                            }
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400">
                                        Create or import a wallet in your
                                        browser
                                    </p>
                                </div>
                                <span className="text-2xl">🔐</span>
